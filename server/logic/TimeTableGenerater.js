...
batch,
stuperbatch,
facuties,{name :fac name, subject:subject name}
university name
...
function allocateSessionsForSlot(
  ...
  // console.log("Available Faculty :::::::::::::::", availableFaculties);
  ...
  availableFaculties.forEach((faculty, j) => {
    ...
    console.log("single Faculty :::::::::::::::", singlefaculty);
    ...
    console.log("Department Subject :::::::::::::::", departmentSubject);
